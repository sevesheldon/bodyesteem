 ...
 * The public-facing functionality of the module.
 */
class Powerkit_Basic_Shortcodes_Public extends Powerkit_Module_Public {
	...
	public function wp_enqueue_scripts() {
		// Styles.
		wp_enqueue_style( 'powerkit-basic-shortcodes', plugin_dir_url( __FILE__ ) . 'css/public-powerkit-basic-shortcodes.css', false, powerkit_get_setting( 'version' ), 'screen' );

		// Add RTL support.
		wp_style_add_data( 'powerkit-basic-shortcodes', 'rtl', 'replace' );

		// Scripts.
		wp_enqueue_script( 'powerkit-basic-shortcodes', plugin_dir_url( __FILE__ ) . 'js/public-powerkit-basic-shortcodes.js', array( 'jquery' ), '4.0.0', true );
	}
}
