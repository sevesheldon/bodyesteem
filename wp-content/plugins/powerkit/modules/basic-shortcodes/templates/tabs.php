...
function powerkit_basic_shortcodes_tabs( $output, $atts, $content ) {
	...
	$output .= '<div class="pk-container">';
	$output .= '<div class="pk-navigation"><ul class="pk-nav pk-nav-' . $atts['type'] . '" role="tablist">' . $nav_items . '</ul></div>';
	$output .= '<div class="pk-content"><div class="pk-tab-content">' . $pane_items . '</div></div>';
	$output .= '</div>';
	$output .= '</div>';
