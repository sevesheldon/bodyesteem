 ...
 */
function powerkit_get_image_placeholder( $width = 1, $height = 1, $cached = false ) {
 ...
 */
function powerkit_attachment_attr_to_object( $attr ) {
	if ( ! isset( $attr['src'] ) ) {
		return;
	}
 ...
 * @param string $attr The img attr.
 */
function powerkit_attachment_attr_to_size( $attr ) {
	if ( ! isset( $attr['class'] ) ) {
		return;
	}
