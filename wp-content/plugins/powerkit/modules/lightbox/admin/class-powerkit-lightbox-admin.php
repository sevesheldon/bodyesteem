...
class Powerkit_Lightbox_Admin extends Powerkit_Module_Admin {
	...
	public function powerkit_lightbox_gallery_selectors_callback() {
		?>
			<textarea class="regular-text" id="powerkit_lightbox_gallery_selectors" name="powerkit_lightbox_gallery_selectors" rows="8"><?php echo esc_attr( get_option( 'powerkit_lightbox_gallery_selectors', '.gallery' ) ); ?></textarea>
