...
class Powerkit_Lightbox_Public extends Powerkit_Module_Public {
	...
	public function wp_enqueue_scripts() {
		// Styles.
		wp_enqueue_style( 'powerkit-lightbox', plugin_dir_url( __FILE__ ) . 'css/public-powerkit-lightbox.css', array(), powerkit_get_setting( 'version' ), 'all' );
		...
		$gallery_selectors      = get_option( 'powerkit_lightbox_gallery_selectors', array( '.gallery' ) );
