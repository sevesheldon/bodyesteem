 ...
 */
class Powerkit_Pinterest_Widget extends WP_Widget {
 ...
 * Register Widget
 */
function powerkit_widget_init_pinterest() {
	register_widget( 'Powerkit_Pinterest_Widget' );
}
add_action( 'widgets_init', 'powerkit_widget_init_pinterest' );
