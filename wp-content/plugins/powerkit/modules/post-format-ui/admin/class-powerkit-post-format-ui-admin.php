...
class Powerkit_Post_Format_UI_Admin extends Powerkit_Module_Admin {
	...
	public function add_custom_meta_boxes() {
		add_meta_box( 'powerkit-post-format-link', esc_html__( 'Link', 'powerkit' ), array( $this, 'link_markup' ), 'post', 'after_title', 'high', null );
		add_meta_box( 'powerkit-post-format-audio', esc_html__( 'Audio', 'powerkit' ), array( $this, 'audio_markup' ), 'post', 'after_title', 'high', null );
		add_meta_box( 'powerkit-post-format-video', esc_html__( 'Video', 'powerkit' ), array( $this, 'video_markup' ), 'post', 'after_title', 'high', null );
		add_meta_box( 'powerkit-post-format-gallery', esc_html__( 'Gallery', 'powerkit' ), array( $this, 'gallery_markup' ), 'post', 'after_title', 'high', null );
	}
	...
	/**
	 * Unset 'ui_after_title' context from the post's meta boxes.
	 */
	...
	public function admin_enqueue_scripts( $page ) {
		if ( 'post.php' === $page || 'post-new.php' === $page ) {
			...
			// Styles.
			wp_enqueue_style( 'powerkit-post-format-ui', plugin_dir_url( __FILE__ ) . 'css/admin-powerkit-post-format-ui.css', array(), powerkit_get_setting( 'version' ), 'all' );
