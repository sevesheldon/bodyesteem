...
function powerkit_share_buttons_shortcode( $atts, $content = '' ) {
	...
	// Get Shares.
	powerkit_share_buttons( $params['accounts'], $params['total'], $params['icons'], $params['titles'], $params['labels'], $params['counts'], $params['count_location'], $params['mode'], $params['layout'], $params['scheme'], '' );
