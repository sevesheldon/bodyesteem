 ...
 * The public-facing functionality of the module.
 */
class Powerkit_Widget_Posts_Public extends Powerkit_Module_Public {
	/**
	 * Initialize
	 */
	...
	public function register_templates( $templates = array() ) {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/featured-posts-template.php';
	}
	...
	public function wp_enqueue_scripts() {
		wp_enqueue_style( 'powerkit-widget-posts', plugin_dir_url( __FILE__ ) . 'css/public-powerkit-widget-posts.css', array(), powerkit_get_setting( 'version' ), 'all' );
